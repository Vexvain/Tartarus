...
#Usage
#[!] EasyFilter 1.0 by Alemalakra, rewritten :)
...
if len(sys.argv) < 2:
    print '[!] EasyFilter 1.0 by Alemalakra, rewritten :)'
    print '[!] Usage: filter.py <INPUT> <OUTPUT> <PROTOCOL> <MIN BYTES> <OUTPUT SYNTAX>'
    print '[!] Protocols: chargen, ntp, quake, ssdp, ldap, dns, snmp, mdns, tftp, portmap, netbios'
